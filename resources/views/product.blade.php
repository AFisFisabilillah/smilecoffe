                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('category', $product->category->slug) }}"
                            class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">{{$product->category->name}}</a>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                ...
                <div class="mt-6 sm:mt-8 lg:mt-0">
                    ...
                    <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                        <a href="#" title=""
                            class="flex items-center justify-center py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blueCustom-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                            role="button">
