<div
    class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 flex-shrink-0 card w-full md:w-1/2 lg:w-1/3 col-span-12 lg:col-span-3 xl:col-span-4">
    ...
    <div class="pt-6">
        <div class="mb-4 flex items-center justify-between gap-4">
            <span
                class="me-1 rounded bg-blueCustom-100 px-2.5 py-0.5 text-xs font-medium text-blueCustom-800 dark:bg-blueCustom-900 dark:text-cyan-800">
                Up to 35% off </span>
            <span
                class="me-1 rounded bg-blueCustom-100 px-2.5 py-0.5 text-xs font-medium text-cyan-800 dark:bg-blueCustom-900 dark:text-cyan-800">
        ...
        <div class="mt-4 flex items-center justify-between gap-4">
            ...
            <a href="{{ route('product', $product->id) }}" title=""
