    ...
    <div class="relative p-4 w-full max-w-xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <p class="text-gray-500 dark:text-gray-400 mb-4">{{  count($carts)  }} Products on your Carts</p>
                <ul class="space-y-4 mb-4 h-80 overflow-y-scroll no-scrollbar">
                    ...
                    <li class="">
                        ...
                        <label for="job-1"
                            ...
                            <div class="block">
                                <div class="w-full text-lg font-semibold">{{ $cart->products->name }}</div>
                                <div class="w-full text-gray-500 dark:text-gray-400">Rp.{{ number_format($cart->products->price, 0,',','.') }}</div>
                            </div>
